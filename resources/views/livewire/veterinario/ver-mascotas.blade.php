<div class="container w-full">
    ...
    <h3 class="font-semibold text-2xl text-center">Mascotas del cliente</h3>
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="py-2 px-2 h-10">
                            <div class="text-center">
                                <div class="rounded h-10 bg-[#823E70] mb-2">
                                    <a href="/ver-cartilla/{{ $mascota->id }}" class="text-white py-1 px-3 h-10"><i class="fa fa-note" aria-hidden="true"></i> Ver Cartilla</a>
                                </div>

                                <div class="bg-[#EFBBE1] text-white py-1 px-2 rounded text-xs h-10">
                                    <button wire:click="delete({{ $mascota->id }})" class="h-10" >Eliminar Mascota</button>
                                </div>
                            </div>
                        </td>
                    </tr>
